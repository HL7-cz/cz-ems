...
* vitalSigns 0..* Base "A.2.6.2 - Basic Vital Signs" """Results of basic vital signs measurements for the patient including the measurement timestamp. (Vital signs measurements may be repeated at different times during an emergency call)."""
  * type 1..1 CodeableConcept "A.2.6.2.1 - Examination type" """Classification of the examination type. Here fixed value ''vital-signs''"""
  ...
  * parametricRecord 0..* Base "A.2.6.2.3 - Parametric record of the examination result" """Parametric entry of the examination result."""
    ...
    * oxigenAdministration 0..1 boolean "A.2.6.2.3.2 - Oxygen administration" """Information about oxygen administration during SpO2 value measurement."""
    * oxgenFlow 0..1 Quantity "A.2.6.2.3.3 - Oxygen flow rate" """Information about oxygen flow rate during SpO2 value measurement."""
...
- Consciousness - AVPU (A/V/P/U) - EtCO2"""
  ...
  * parametricRecord 0..1 Base "A.2.6.3.2 - Parametric record of the examination result" """Parametric entry of the examination result."""
    * description 1..1 CodeableConcept "A.2.6.3.2.1 - Examination description" """Description of the examination, including the examination code, date and time of examination."""
    * result 1..1 Quantity "A.2.6.3.2.2 - Formalized examination result" """Examination result as text and/or in the form of numerical and coded measurement results. Furthermore, details on how the tests were performed to obtain the final values, information on reference ranges and interpretation of the result. The content of the examination result will differ according to the type of examination."""
    * date 1..1 dateTime "A.2.6.3.2.3 - Date and time of measurement" """Date and time related to a specific measurement."""
