...
* body 1..1 Base "A.2 - EMS Report body data element" """EMS Report body data element"""
  ...
  * presentingIllness 0..1 PresentingIllnessEmsCz "A.2.5 - Presenting Illness" """Presenting illness"""
  ...
  * attachments 0..1 AttachmentsEMSCz "A.2.11 - Dispatch Attachments" """Dispatch attachments"""  
