...
* alergie.puvodce 1..1 CodeableConcept "A.2.4.1.2 - Původce" """Látka, skupina látek nebo faktor prostředí, na které je pacient alergický nebo přecitlivělý. Původce je možné vyjádřit pomocí kódu substance, ATC skupiny nebo kódu produktu SÚKL (v případě léčivých přípravků)."""
* alergie.typReakce 0..1 CodeableConcept "A.2.4.1.3 - Typ reakce" """Typ (mechanismus) reakce: alergie, intolerance, nealergická hypersenzitivita."""
...
* varovani.uroven 0..1 CodeableConcept "A.2.4.2.6 - Úroveň" """Úroveň závažnosti varování"""
* varovani.platnost 0..1 Base "A.2.4.2.7 - Období platnosti varování" """Umožňuje vyjádřit období ve kterém bylo varování aktivní. Týká se přechodných stavů."""
