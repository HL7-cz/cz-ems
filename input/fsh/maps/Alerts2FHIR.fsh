...
* group[=].element[=].display = "A.2.4.2 - Medical alerts (relevant for the respective hospital stay)"
* group[=].element[=].target.code = #Composition.section:sectionAlerts
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto

* group[=].element[+].code = #Alerts.medicalAlerts.description
* group[=].element[=].display = "A.2.4.2.1 - Healthcare alert description"
...
* group[=].element[=].display = "A.2.4.2.3 - Healthcare alert code(s)"
...
* group[=].element[=].display = "A.2.4.2.4 - Healthcare alert specialist physician"
...
* group[=].element[=].display = "A.2.4.2.5 - Healthcare alert comment"
* group[=].element[=].target.code = #Flag.text
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[=].target.comment = "TO BE checked"
...
* group[=].element[=].display = "A.2.4.2.6 - Healthcare alert priority"
...
* group[=].element[=].display = "A.2.4.2.7 - Healthcare alert period"
