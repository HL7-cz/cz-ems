...
* group[=].element[=].target.code = #CZ_ProcedureEms.usedReference
* group[=].element[=].target.display = "CZ_ProcedureEms.usedReference.ofType(CZ_MedicationCoreAdministration)"
* group[=].element[=].target.equivalence = #equivalent
* group[+].source = "https://hl7.cz/fhir/cz-ems/StructureDefinition/TherapyEmsCz"
...
* group[=].element[=].display = "A.2.7.2 Medical devices"
* group[=].element[=].target.code = #CZ_ProcedureEms.usedReference			
* group[=].element[=].target.comment = "CZ_ProcedureEms.usedReference.ofType(CZ_MedicationCoreDevice)"
* group[=].element[=].target.equivalence = #relatedto
...
* group[=].element[=].display = "A.2.7.3 Medication"
* group[=].element[=].target.code = #CZ_ProcedureEms.usedReference			
* group[=].element[=].target.comment = "CZ_ProcedureEms.usedReference.ofType(CZ_MedicationCoreAdministration)"
* group[=].element[=].target.equivalence = #relatedto
...
* group[=].element[=].target.code = #CZ_MedicationCoreAdministration.medication.code.text
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #Medication.groupATC
* group[=].element[=].display = "A.2.7.3.3 ATC group"
* group[=].element[=].target.code = #CZ_MedicationCoreAdministration.Medication[x].code
...
* group[=].element[=].target.code = #CZ_MedicationCoreAdministration.Medication[x].item[x]:itemCodeableConcept	
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #Medication.strength
* group[=].element[=].display = "A.2.7.3.5 Strength"
* group[=].element[=].target.code = #CZ_MedicationCoreAdministration.Medication[x].ingredient.strength
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #Medication.medicinalForm
* group[=].element[=].display = "A.2.7.3.6 Form of the medicinal product"
* group[=].element[=].target.code = #CZ_MedicationCoreAdministration.Medication[x].form
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
