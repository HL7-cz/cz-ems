On the following page, you will find notes on implementing the the Emergency Medical Service (EMS) Record of Intervention (ZOV ZZS). They concern the creation of a bundle, its composition, and filling these profiles with the relevant data.
